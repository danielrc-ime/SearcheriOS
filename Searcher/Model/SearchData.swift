...
//titulo  plpResults.records[0].productDisplayName
//precio  plpResults.records[0].promoPrice
//ubicacion  plpResults.records[0].category
//imagen  plpResults.records[0].smImage
...
struct PlpState: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case categoryID = "categoryId"
        case currentSortOption, currentFilters, firstRecNum, lastRecNum, recsPerPage, totalNumRecs, originalSearchTerm
    }
}
...
struct Record: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case productDisplayName, productType, productRatingCount, productAvgRating, listPrice, minimumListPrice, maximumListPrice, promoPrice, minimumPromoPrice, maximumPromoPrice, isHybrid, isMarketPlace, isImportationProduct, brand, seller, category, smImage, lgImage, xlImage, groupType, plpFlags
    }
}
